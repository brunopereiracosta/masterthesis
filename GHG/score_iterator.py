...
# directory = 'conv1D_GRU_20_11_2020'
# path = '/Volumes/PEN/GHG/' + directory
# # path = '/Users/bpc/6º Ano-2º Sem./Tese/Coding/GHG/' + directory
# hp = get_scores(path,6)
...
# # print(hp[0])
# print(hp[0][0]) # hyperparameters for model with lowest score in a given fold (last parameter)
# print(hp[1][0]) # hyperparameters for model with 2nd lowest score in 1st fold
# print(hp[2][0]) # hyperparameters for model with 3rd lowest score in 1st fold
# print(hp[3][0]) # hyperparameters for model with 3rd lowest score in 1st fold
# print(hp[4][0]) # hyperparameters for model with 3rd lowest score in 1st fold
# print(hp[5][0]) # hyperparameters for model with 3rd lowest score in 1st fold